...
export const ui = {
  zh: {
    ...
    'price.f3': '自动化配置邮件投递与专属社区支持',
    'price.f4': '支持微信、信用卡及 USDT 免手续费直付',
    'price.btn': '立即获取授权 ($9.99)',
    'price.help': '需要新手协助？联系 @NodeAuthBot 即可获取 1v1 代部署',
    ...
    'footer.desc': '基于 GNU AGPL v3 协议开源，我们坚守代码透明。',
  ...
  en: {
    ...
    'price.f3': 'Automated setup email & exclusive community support',
    'price.f4': 'Zero-fee payments via Card, Crypto & WeChat',
    'price.btn': 'Get License ($9.99)',
    'price.help': 'Need deployment assistance? Contact @NodeAuthBot for 1v1 help',
    ...
    'footer.desc': 'Open sourced under GNU AGPL v3, we stand by code transparency.',
    'footer.rights': '&copy; 2026 NodeAuth. All rights reserved.',
    'footer.tools': 'Tools',
